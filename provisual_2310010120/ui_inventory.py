...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        if (self.tblInventory.columnCount() < 5):
            self.tblInventory.setColumnCount(5)
    ...
    def retranslateUi(self, Form):
        ...
        ___qtablewidgetitem3.setText(QCoreApplication.translate("Form", u"Satuan", None));
        ___qtablewidgetitem4 = self.tblInventory.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("Form", u"Jumlah", None));
